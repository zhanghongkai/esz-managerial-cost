...
Section~\ref{ss:Policy_Fit} support
...
$\alpha_{\tau}$ of this equation can still be estimated because 
$\Monitor_{it}$ affects the distribution of observed price changes
or lack thereof through the latent price change equation
...
comparison of the OP model omitting monitoring (model D) against any of the ZIOP
models (models A--C). This suggests that including the monitoring equation produces
a substantially better fit. The preferred ZIOP specification (model A) has a
considerable $Z$ statistic of 3.20 and 3.92 when tested against the
alternatives that either shift (model B) or delete variables (model C) from the monitoring
